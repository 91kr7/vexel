...
| `config-reading-mirrors-editing` | F3b — Config in reading is the edit form, read | REQ-46 … REQ-57, REQ-59, REQ-60 | `config-reading-layout`, `config-editing-cards` | certified | The setting the operator just read is where they left it after pressing Edit |
