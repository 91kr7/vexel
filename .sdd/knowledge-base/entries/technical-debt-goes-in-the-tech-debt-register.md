...
scope: any
date: 2026-08-27
source: chat, after the second reading of the refresh-and-polling study
---
...
order, see [[an-opinion-asked-for-is-not-a-work-order]]. When a later cycle fixes one, set
`status: closed`, name the plan that closed it, and leave the entry standing — the register is a
record, like the analyses, see [[past-analyses-and-plans-are-never-touched]].
