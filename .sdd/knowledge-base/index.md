...
| batch-closing-commands | how-to | test | The plan's last batch closes on `npm run test:e2e -w client -- --quiet` and `npm run test`, in full; earlier batches run only their own tests | `entries/batch-closing-commands.md` |
