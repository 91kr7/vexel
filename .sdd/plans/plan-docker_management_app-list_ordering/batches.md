...
- **The dashboard's activity list will be "fixed" by somebody.** It sorts client-side, which reads
  like the thing REQ-28 forbids, and it is deliberate. REQ-42 and the note in the requirements are
  the only defence.
