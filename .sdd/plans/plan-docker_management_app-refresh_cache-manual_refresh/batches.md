...
|-------|---------|------------|---------|--------|------------------|
| manual-refresh | The refresh control, the reload behind it and the screen that shows the result | REQ-1, REQ-2, REQ-3, REQ-4, REQ-5, REQ-6, REQ-7, REQ-8, REQ-9, REQ-10, REQ-11, REQ-12, REQ-13, REQ-14, REQ-15 | — | todo | A context created from the terminal appears after one press |
