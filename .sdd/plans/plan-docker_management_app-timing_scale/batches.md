...
|-------|---------|------------|---------|--------|------------------|
| [batch-timing-scale](batches/batch-timing-scale.md) | Timing scale — one factor governs every cadence of the product (foundation batch) | REQ-1 … REQ-21 (all) | — | todo | The product keeps its own rhythm when nothing is set |
