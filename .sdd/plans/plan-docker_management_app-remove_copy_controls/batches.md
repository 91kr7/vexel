...
| 2 · console-check-awaits-the-command | F9 — the raw-console check drives the console by its contract: the second command is sent after the first has ended, everything the check verifies stays, and the debt entry leaves the register | REQ-36, REQ-37, REQ-38, REQ-39, REQ-40, REQ-41, REQ-42 | — | todo | The console check passes wherever it is run |
