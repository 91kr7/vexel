...
| `processes-fills-its-tab` | F6 — The process table takes the height it is offered | REQ-32, REQ-33 | `stable-detail-height` | implemented | The process list uses the room the dialog gives it |
