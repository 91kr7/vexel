...
| `inspect-grouped` | F6b — Inspect grouped, and a bad exit code that reads as one | REQ-34, REQ-35, REQ-36, REQ-37, REQ-38, REQ-39, REQ-40, REQ-41, REQ-42, REQ-43, REQ-44, REQ-45 | `stable-detail-height` | implemented | What the container is, and how it has gone, read as two questions |
