...
| `detail-identity-header` | F1 — The header carries the container's identity | REQ-6, REQ-7, REQ-8, REQ-9, REQ-10 | `stable-detail-height` | implemented | The dialog's header says as much as the card the operator just left |
