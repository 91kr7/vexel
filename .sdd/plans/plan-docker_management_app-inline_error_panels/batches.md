...
| --- | --- | --- | --- | --- | --- |
| 1 · failures-become-toasts | F2 — Every other failure is a toast | REQ-5, REQ-6, REQ-7, REQ-8, REQ-13 | — | implemented | A failed action is reported by a toast and by nothing in the page |
