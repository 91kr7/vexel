...
| 3 · header-connection-report | F3 — The header is the only report of the connection | REQ-9, REQ-10, REQ-11, REQ-12 | — | certified | The header names what is unreachable, and the screen fills again when it returns |
