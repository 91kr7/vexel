...
| `batch-artifacts-follow-the-registry` | The artifacts describe what the run's registry actually holds | REQ-76, REQ-77, REQ-78 | `batch-clean-daemon-recorded` | certified | No comment names something that was removed |
