...
|-------|---------|------------|---------|--------|------------------|
| `batch-containers-arrive-by-push` | The live channel exists, carries every value the server holds, and the container listing arrives on it | REQ-1, REQ-2, REQ-3, REQ-4, REQ-5, REQ-6, REQ-7, REQ-8, REQ-9, REQ-10, REQ-11, REQ-12, REQ-13, REQ-14, REQ-15, REQ-16, REQ-26, REQ-32, REQ-35, REQ-40 | — | todo | The container list follows the host with no clock in the browser |
