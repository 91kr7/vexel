...
| `batch-connection-status-arrives-by-push` | The connection status arrives on the live channel, and the browser holds no clock at all | REQ-17, REQ-18, REQ-19, REQ-20, REQ-36, REQ-37, REQ-38, REQ-39 | `batch-every-listing-arrives-by-push` | certified | The daemon coming back is noticed with no clock in the browser |
