...
| REQ-19 | Opening and closing one of the four with no panel open leaves the operator's point of interaction somewhere stable in the images list — never lost to the document as a whole, and never on an element that no longer exists. |
