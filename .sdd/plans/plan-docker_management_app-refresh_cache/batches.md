...
| detail-reread-scoped | A detail view re-reads only for the object it shows | REQ-6, REQ-7, REQ-8 | — | implemented | Another container's activity leaves the open detail alone |
