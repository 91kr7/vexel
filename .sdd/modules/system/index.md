...
| System endpoints | REST endpoint | `server/src/system/system-routes.ts` | Exposes the host overview, the reclaimable-space breakdown and the scoped prune to the client | `specs/system-endpoints.md` |
| System client | frontend data client | `client/src/data/system-client.ts` | Typed `fetch` wrapper for the overview, disk-usage and prune endpoints | `specs/system-client.md` |
