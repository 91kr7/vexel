...
| usePlugins | frontend hook | `client/src/data/use-plugins.ts` | Reads both inventories as one round on a bounded poll, on a context switch and on the reload signal, and drives install/enable/disable/inspect/remove; a listing equal to the one held replaces nothing | `specs/use-plugins.md` |
