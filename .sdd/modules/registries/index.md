...
| RegistriesScreen | UI component | `client/src/registries/RegistriesScreen.tsx` | The Registries screen: registries listed with the object list's comfortable variant (account, credential store, authentication state, plain-http flag) with log in and log out as row actions, repository and tag browser with search and sizes, and pull of a selected tag | `specs/registries-screen.md` |
