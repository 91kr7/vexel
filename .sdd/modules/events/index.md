...
| Event stream client | frontend data client | `client/src/data/event-stream.ts` | Live-event subscription over one shared connection; its only caller in the client is the shell's event-feed service | `specs/event-stream-client.md` |
