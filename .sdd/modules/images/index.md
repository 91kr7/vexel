...
| ImagesScreen | UI component | `client/src/images/ImagesScreen.tsx` | The Images screen: toolbar (pull, prune dangling), searchable card list of local images, per-image tag/untag/push/remove actions with destructive confirmation on remove, pull/push progress dialogs | `specs/images-screen.md` |
