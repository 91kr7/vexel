...
// availability into a single status the server holds and pushes on the live
// channel (REQ-9, REQ-10, REQ-13, REQ-110). The shared EngineClient it probes
// with is the Docker access layer's own, which follows the active context
// (REQ-93); it stays re-exported here for the modules that already read it from
// this service.
