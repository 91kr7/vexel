...
/**
 * `ui-library/specs/icon-button.md` — the two sizes and the rounding each carries. jsdom applies no
 * stylesheet, so the rounding is read where it is written; the box is measured in
