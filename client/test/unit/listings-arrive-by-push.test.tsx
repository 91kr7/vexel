 ...
 * table, whichever row it was — and `useComposeProjects`, which has no file of
 * its own, is covered by being in it. What each hook does beyond the listing —
 * its actions, its malformed deliveries, the context it names active — stays in
 * that hook's own file.
 *
